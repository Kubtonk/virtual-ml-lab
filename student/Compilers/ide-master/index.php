...
<body onload=instruct()>
    <div id="site-navigation" class="ui small inverted menu">
        <div id="site-header" class="header item">
                ...
                <h2><a href="http://resources.vardhaman.org/images/<?php echo "cse";?>/<?php echo $studentid ?>.jpg" ><img src="http://resources.vardhaman.org/images/<?php echo "cse";?>/<?php echo $studentid ?>.jpg" style="width:30px;height:30px;border:solid 1px #AAAAAA;border-radius: 50%"></a><?php echo $studentid; ?></h2>
